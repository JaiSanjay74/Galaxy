...
async function configureSecurity() {
    ...
    fetch("http://localhost:7000/security/RsaPublicKey"/*"https://yak-upright-urgently.ngrok-free.app/security/RsaPublicKey"*/).then(async(v)=>{
...
function AESEncryptData(data){
    ...
    if(server_public_key != null){
        ...
        console.log(JSON.stringify(Encryptset))
        return Encryptset
    }
    else{
